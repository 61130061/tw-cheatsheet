...
import flexAndGrid from "./data/FnG.json";
import spacing from "./data/Spacing.json";
import sizing from "./data/Sizing.json";
...
<template>
  <div class="h-screen flex flex-col dark:bg-gray-900 text-gray-800 dark:text-gray-50">
    <Navbar />
    <div class="flex-1">
